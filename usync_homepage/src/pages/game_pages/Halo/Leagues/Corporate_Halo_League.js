    ...
    return (
        <div>
            <header>
              ...
              <img src={sndleagueheader} alt="Corporate Halo League Header" className="Header-Img" />
            </header>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-2'>
                        ...
                        <p>Charity Donation Prize Pool</p>
                        <p>One Match Every Sunday</p>
                        <p>7 Week Regular Season with Playoffs</p>
                        <h1>Region/Type:</h1>
                        <p>4v4 - NA</p>
                    </div>
                    <div className='col-2'>
...
export default Corporate_Halo_League;