    ...
    return (
        <div>
            <header>
              ...
              <img src={sndleagueheader} alt="ECAC Halo League Header" className="Header-Img" />
            </header>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-2'>
                        ...
                        <p>$1600/yr for ECAC Membership</p>
                    </div>
                </div>
            </div>
        </div>
...
export default ECAC_Halo_League;