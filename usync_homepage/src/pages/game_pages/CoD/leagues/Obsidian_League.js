    ...
    return (
        <div>
            <header>
              ...
              <img src={sndleagueheader} alt="Obsidian League Header" className="Header-Img" />
            </header>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-2'>
                        ...
                        <p>$1400 Prize Pool (Estimated)</p>
                        <p>Live Streamed Matches</p>
                        <p>Disorganized Structure</p>
                        <p>Randomly Hosted Yearly</p>
                        <h1>Region/Type:</h1>
                        <p>4v4 - NA</p>
                    </div>
                    <div className='col-2'>
...
export default Obsidian_League;