    ...
    return (
        <div>
            <header>
              ...
              <img src={sndleagueheader} alt="WYGGZZ League Header" className="Header-Img" />
            </header>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-2'>
                        ...
                        <p>$500- $1000 Prize Pool (Estimated)</p>
                        <p>Highly Competitive</p>
                        <p>Live Streamed Matches</p>
                        <p>Limited Sign Ups</p>
                        <h1>Region/Type:</h1>
                        <p>4v4 - All Regions</p>
                    </div>
                    <div className='col-2'>
