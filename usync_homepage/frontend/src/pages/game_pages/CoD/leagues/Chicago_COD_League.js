    ...
    return (
        <div>
            ...
            <div className='Background-mid'>
                ...
                <a href='https://twitter.com/ChicagoCDL/media?s=21&t=fa2qbQHaft6d5qiwyTRVmQ'target='_blank' rel='noopener noreferrer'>
                ...
                <div className='container'>
                    ...
                    <div className='row'id='league-row'>
                        ...
                        <h1 className='info-title'>Details:</h1>
                            ...
                            <p>4 Week Regular Season / 1 Week Playoffs</p>
                            <p>8 Teams MAX</p>
...
export default Chicago_COD_League;