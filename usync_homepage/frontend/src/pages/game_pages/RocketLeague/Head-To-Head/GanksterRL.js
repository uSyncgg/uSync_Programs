        ...
        <div>
            <body id='league-body'>
              ...
              Change the name inside the {} to be whatever the imported image is but className is the same */}
                    <img src="https://i.imgur.com/AP1cBdg.png" className='Header-Img' />
                </header>
                ...
                along with changing the uSync Verified to the Not verified image and change the alt to Not Verififed*/}
                    ...
                    <a href='https://rocketleague.gankster.gg/login?session=yes'target='_blank' rel='noopener noreferrer'>
                    ...
                    <a href='https://www.usync.gg/games/RocketLeague/head-to-head'>
