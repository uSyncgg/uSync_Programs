            ...
            <body id='league-body'>
              ...
              Change the name inside the {} to be whatever the imported image is but className is the same */}
                ...
                along with changing the uSync Verified to the Not verified image and change the alt to Not Verififed*/}
                    ...
                    <a href='https://www.playvs.com/rocket-league'target='_blank' rel='noopener noreferrer'>
                    ...
                    <div className='container'>
                        ...
                        Keep button the same */}
                            ...
                            <div className='col-2' id='league-info'>
                                ...
                                <p>8 Week Regular Season, 3 Week Playoffs</p>
                                <p>7 Matches in Regular Season</p>
                                <p>Multiple Regional Divisions</p>
                            ...
                            <div className='col-2' id='league-info'>
                                ...
                                <p>Contact PlayVS for a Quote - Must be a High School Student</p>
                            </div>
                        </div>
                    </div>
