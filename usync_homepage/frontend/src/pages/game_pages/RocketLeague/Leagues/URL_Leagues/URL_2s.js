        ...
        <div>
            <body id='league-body'>
              ...
              Change the name inside the {} to be whatever the imported image is but className is the same */}
                    <img src="https://i.imgur.com/YG5mBVv.jpg" className='Header-Img' />
                </header>
                ...
                along with changing the uSync Verified to the Not verified image and change the alt to Not Verififed*/}
                    ...
                    <a href='https://linktr.ee/ultimaterocketleague'target='_blank' rel='noopener noreferrer'>
                    ...
                    <a href='https://www.usync.gg/games/RocketLeague/leagues/url-leagues'>
