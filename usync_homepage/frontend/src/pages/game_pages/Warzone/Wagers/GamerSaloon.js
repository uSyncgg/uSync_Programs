...
import Oneup_Wagers from '../../CoD/Wagers/Oneup_Wagers';
    ...
    return (
        <div>
            <header>
              ...
              <img src={sndleagueheader} alt="GamerSaloon Wagers Header" className="Header-Img" />
            </header>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-2'>
                        ...
                        <p>1v1 Kill Race Console ONLY</p>
