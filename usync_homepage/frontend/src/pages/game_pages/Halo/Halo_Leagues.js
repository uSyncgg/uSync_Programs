                    ...
                    <div className='row'>
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <a href="https://imgur.com/bHzfdu8"><img src="https://i.imgur.com/bHzfdu8.png" className='league-img' /></a>
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/6cA46YH"><img src="https://i.imgur.com/6cA46YH.png" className='league-img' /></a>
                                <a href="https://www.usync.gg"><img src="https://i.imgur.com/PCHIHQB.png" title="uSync Verified" className='over-img'/></a>
                                </div>
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/SnE3px8"><img src="https://i.imgur.com/SnE3px8.png" className='league-img' /></a>
                                <a href="https://imgur.com/0MPIBOK"><img src="https://i.imgur.com/0MPIBOK.png" title="NOT Verified" className='over-img' /></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                {/* <img src={check} alt="uSync Verified" className='check' /> */}
