                    ...
                    <div className='row'>
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <a href="https://imgur.com/34aS7tl"><img src="https://i.imgur.com/34aS7tl.png" className='league-img' /></a>
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                <h1 className='Leagueh1'>LPL League</h1>
                                <div className='parent'>
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/KDf5r2a"><img src="https://i.imgur.com/KDf5r2a.png" className='league-img' /></a>
                                <a href="https://imgur.com/0MPIBOK"><img src="https://i.imgur.com/0MPIBOK.png" title="NOT Verified" className='over-img' /></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                {/* <img src={check} alt="uSync Verified" className='check' /> */}
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/TJdbPmz"><img src="https://i.imgur.com/TJdbPmz.png" className='league-img' /></a>
                                <a href="https://imgur.com/0MPIBOK"><img src="https://i.imgur.com/0MPIBOK.png" title="NOT Verified" className='over-img' /></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                {/* <img src={check} alt="uSync Verified" className='check' /> */}
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/8h5GWaO"><img src="https://i.imgur.com/8h5GWaO.png" className='league-img' /></a>
                                <a href="https://imgur.com/0MPIBOK"><img src="https://i.imgur.com/0MPIBOK.png" title="NOT Verified" className='over-img' /></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                {/* <img src={check} alt="uSync Verified" className='check' /> */}
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/PAZu639"><img src="https://i.imgur.com/PAZu639.png" className='league-img' /></a>
                                <a href="https://imgur.com/0MPIBOK"><img src="https://i.imgur.com/0MPIBOK.png" title="NOT Verified" className='over-img' /></a>
                                </div>
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/vLKklOa"><img src="https://i.imgur.com/vLKklOa.png" className='league-img' /></a>
                                <a href="https://imgur.com/0MPIBOK"><img src="https://i.imgur.com/0MPIBOK.png" title="NOT Verified" className='over-img' /></a>
                                </div>
                                <p className='Leaguep'>EU</p>
                                {/* <img src={check} alt="uSync Verified" className='check' /> */}
                        ...
                        <div className='col-lg-6'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                <a href="https://imgur.com/1Hqgxu0"><img src="https://i.imgur.com/1Hqgxu0.png" className='league-img' /></a>
                                <a href="https://www.usync.gg"><img src="https://i.imgur.com/PCHIHQB.png" title="uSync Verified" className='over-img'/></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                {/* <img src={check} alt="uSync Verified" className='check' /> */}
