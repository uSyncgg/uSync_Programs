            ...
            <body id='league-body'>
              ...
              Change the name inside the {} to be whatever the imported image is but className is the same */}
                ...
                along with changing the uSync Verified to the Not verified image and change the alt to Not Verififed*/}
                    ...
                    <a href='https://app.ggleagues.com/leagues?esports=league_of_legends'target='_blank' rel='noopener noreferrer'>
                    ...
                    <div className='container'>
                        ...
                        Keep button the same */}
                            ...
                            <div className='col-2' id='league-info'>
                                ...
                                <p>$575 Prize Pool</p>
                                <p>Teams Assigned Division Based on Player Ranks</p>
                                <p>5-7 Week Regular Season</p>
                    ...
                    <a href='https://www.usync.gg/games/LoL/leagues/gg-leagues'>
