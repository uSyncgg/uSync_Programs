            ...
            <body id='league-body'>
              ...
              Change the name inside the {} to be whatever the imported image is but className is the same */}
                ...
                along with changing the uSync Verified to the Not verified image and change the alt to Not Verififed*/}
                    ...
                    <a href='https://discord.com/invite/BK5b2BHxdQ'target='_blank' rel='noopener noreferrer'>
                    ...
                    <div className='container'>
                        ...
                        Keep button the same */}
                            ...
                            <div className='col-2' id='league-info'>
                                ...
                                <p>Platinum 1 99LP cap, One Diamond 4 per team</p>
                            ...
                            <div className='col-2' id='league-info'>
                                <h1 className='info-title'>Entry Free:</h1>
                    ...
                    <a href='https://www.usync.gg/games/LoL/leagues/blue-otter-leagues'>
...
export default Blue_Otter_Plat;