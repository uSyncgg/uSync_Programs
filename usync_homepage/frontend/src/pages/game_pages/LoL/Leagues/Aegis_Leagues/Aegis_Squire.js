    ...
    return (
      ...
      <div className="background-mid">
        <div className="Background-mid-top">
          ...
          <a
            href="https://linktr.ee/aegisesportsgg"
            target="_blank"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>Silver 1 cap, One Gold 4 Allowed</p>
        ...
        <div className="league-back-button-container">
          <a href="https://www.usync.gg/games/LoL/leagues/aegis-leagues" id='league-back-button-a'>
