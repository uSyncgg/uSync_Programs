    ...
    return (
      ...
      <div className="background-mid">
        <div className="Background-mid-top">
          ...
          <a
            href="https://discord.com/invite/RtJa6kY"
            target="_blank"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>$800 Prize Pool</p>
              <p>Platinum 2 Average, Diamond 4 cap</p>
              <p>10 Teams Max</p>
        ...
        <div className="league-back-button-container">
          <a href="https://www.usync.gg/games/LoL/leagues/meta-shift-leagues" id='league-back-button-a'>
