    ...
    return (
      ...
      <div className="background-mid">
        <div className="Background-mid-top">
          ...
          <a
            href="https://discord.com/invite/w4WVB4Z"
            target="_blank"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>Gold 1 Average, NO Platinum 2+</p>
              <p>16 Teams Max</p>
        ...
        <div className="league-back-button-container">
          <a href="https://www.usync.gg/games/LoL/leagues/low-budget-leagues" id='league-back-button-a'>
